...
##Get files
cp /share/hennlab/projects/UKB_Pigmentation/01-Working/d_workspace/glist-hg19 .
cp -s /share/hennlab/projects/UKB_Pigmentation/01-Working/d_workspace/continuous-1717-both_sexes.metaonly.tsv .
