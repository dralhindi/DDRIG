...
# This code is set up to plot the summary statistics from a GWAS.
# It requires a data frame that has a column CHR, BP, and Pvalues present.
...
# -log10(pval) and bonferonni cut off prior to filtering 
...
# create PDF of plot with args in title
