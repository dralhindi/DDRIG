...
for (row in seq_len(nrow(data))) {
  E_Inner_R <- data[row,
                    c("E_Inner_R_Arm_1", "E_Inner_R_Arm_2", "E_Inner_R_Arm_3", "E_Inner_R_Arm_4", "E_Inner_R_Arm_5")]
  data[row, ]$avg_E_Inner_R <- drop_avg(E_Inner_R)

  E_Inner_L <- data[row,
                    c("E_Inner_L_Arm_1", "E_Inner_L_Arm_2", "E_Inner_L_Arm_3", "E_Inner_L_Arm_4", "E_Inner_L_Arm_5")]
  data[row, ]$avg_E_Inner_L <- drop_avg(E_Inner_L)

  M_Inner_R <- data[row,
                    c("M_Inner_R_Arm_1", "M_Inner_R_Arm_2", "M_Inner_R_Arm_3", "M_Inner_R_Arm_4", "M_Inner_R_Arm_5")]
  data[row, ]$avg_M_Inner_R <- drop_avg(M_Inner_R)

  M_Inner_L <- data[row,
                    c("M_Inner_L_Arm_1", "M_Inner_L_Arm_2", "M_Inner_L_Arm_3", "M_Inner_L_Arm_4", "M_Inner_L_Arm_5")]
